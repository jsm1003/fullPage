...
GK.BackgroundDrawable = function() {
  ...
  this.draw = function(camera, time) {
    ...
    this.lightDir = vec3.fromValues(
      -3.0,
      Math.sin(time * 0.001) * 2.0,
      Math.cos(time * 0.0008) * 4.0,
    );
