...
GK.BokehDrawable = function() {
  ...
  this.init = function() {
    ...
    texture1 = GK.TextureManager.loadTexture(
      '/static/img/texture/bokeh1.png',
      true,
      gl.CLAMP_TO_EDGE,
      gl.CLAMP_TO_EDGE,
    );
    texture2 = GK.TextureManager.loadTexture(
      '/static/img/texture/bokeh2.png',
      true,
      gl.CLAMP_TO_EDGE,
      gl.CLAMP_TO_EDGE,
    );
  ...
  this.draw = function(camera, time) {
    ...
    gl.vertexAttribPointer(
      this.program.attributes.aDirection,
      3,
      gl.FLOAT,
      false,
      28,
