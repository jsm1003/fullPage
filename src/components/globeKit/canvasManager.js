...
Site.CanvasManager = function() {
  ...
  this.updateSelectedQuake = function() {
    ...
    self.quakeInfo.style.transform =
      'translate3d(' + screenPos[0] + 'px,' + screenPos[1] + 'px, 0)';
  };
  ...
  this.pulse = function(width, height, variety, duration, waveVector) {
    ...
    a.updateFn = function(value) {
      ...
      self.globe.ringEffectStr =
        BK.Ease.smoothstep(0.0, 0.1, value) -
        BK.Ease.smoothstep(0.8, 1.0, value);
    };
    a.start();
  };
  ...
  this.quakePulse = function() {
    ...
    self.infoAnim.updateFn = function(value) {
      ...
      self.bigQuake.alpha =
        BK.Ease.smoothstep(0.0, 0.1, value) -
        BK.Ease.smoothstep(0.7, 0.8, value);
      self.globe.waveEffectStr =
        BK.Ease.smoothstep(0.0, 0.5, value) -
        BK.Ease.smoothstep(0.5, 1.0, value);
  ...
  this.earthquake = function() {
    ...
    a.updateFn = function(value) {
      ...
      self.globe.ringProgress =
        2.0 * BK.Ease.inOutSine(GKEase.smoothstep(0.2, 1.0, value));
