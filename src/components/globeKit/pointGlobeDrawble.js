...
GK.PointGlobeDrawable = function() {
  ...
  this.init = function() {
    ...
    texture = GK.TextureManager.loadTexture(
      '/static/img/texture/dot.png',
      true,
      gl.CLAMP_TO_EDGE,
      gl.CLAMP_TO_EDGE,
    );
    noiseTexture = GK.TextureManager.loadTexture(
      '/static/img/texture/clouds.png',
      true,
      gl.REPEAT,
      gl.REPEAT,
    );
  ...
  this.draw = function(camera, time) {
    ...
    // Uniforms
    gl.uniformMatrix4fv(
      this.program.uniforms.uPMatrix,
      false,
      camera.perspectiveMatrix,
    );
    gl.uniformMatrix4fv(
      this.program.uniforms.uMVMatrix,
      false,
      this.modelMatrix,
    );
    ...
    gl.vertexAttribPointer(
      this.program.attributes.aPosition,
      3,
      gl.FLOAT,
      false,
      28,
    ...
    gl.vertexAttribPointer(
      this.program.attributes.aTexture,
      2,
      gl.FLOAT,
      false,
      28,
    ...
    gl.vertexAttribPointer(
      this.program.attributes.aStrength,
      1,
      gl.FLOAT,
      false,
      28,
